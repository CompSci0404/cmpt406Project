...
public class SpellIndicator : MonoBehaviour
{
    ...
    private void LateUpdate()
    {
        ...
        for (int i = 0; i<= rayCount; i++)
        {
            ...
            {
                Debug.Log(origin + VectorFromAngle(angle) * viewDistance);
    ...
    public void setAimDiriection(Vector3 aimDirection)
    {
        startingAngle = AngleFromVectorFloat(aimDirection) - fov / 2f;
    }
}
